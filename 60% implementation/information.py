...
def information_frame(self):
    ...
    self.radio_male = tk.Radiobutton(
        self.patient_labelFrame,
        bg=self.background_color,
        variable=self.sex_var, # Used self.sex_var
        value="male",
        text="Male",
        font=("arial", font_size, "normal"),
    )
    ...
    self.radio_pregnant_yes = tk.Radiobutton(
        self.patient_labelFrame,
        bg=self.background_color,
        variable=self.pregnancy_var, # Used self.pregnancy_var
        text="YES",
        value="yes",
    ...
    self.entry_pregnancy_month.config(state=tk.DISABLED, fg="gray") # Initialize as disabled
    ...
    self.save_button = tk.Button(
        ...
        text="Save Data",
        command=self.save_data_to_db, # This command will be defined in Home_window
        font=("arial", 12, "bold"),
        bg="#4CAF50", # Green color for save button
        fg="white",
        padx=10,
        pady=5
    )
    self.save_button.pack(side=tk.BOTTOM, pady=10) # Pack at the bottom of info_frame
